...
e.preventDefault()
axios.put('http://localhost:4000/Organizer/update/'+id,getdata).then((res)=>{
  ...
  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
    ...
    <div className="md:col-span-5">
      ...
      <input type="text" name="Name" id="Name" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
       value={getdata.Name} onChange={(e)=>setgetdata({...getdata,Name:e.target.value})}
        />
    </div>

    <div className="md:col-span-5">
      <label htmlFor="email" className="font-medium">Email Address</label>
      <input type="text" name="Emaail" id="Emaail" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="email@domain.com" 
       value={getdata.Emaail}  onChange={(e)=>setgetdata({...getdata,Emaail:e.target.value})}
      />
    </div>
    ...
    <div className="md:col-span-3">
      ...
      value={getdata.Address}   onChange={(e)=>setgetdata({...getdata,Address:e.target.value})}
      />
    </div>

    <div className="md:col-span-2">
      <label htmlFor="city">Tell</label>
      <input type="text" name="Phone" id="Phone" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="" 
       value={getdata.Phone}   onChange={(e)=>setgetdata({...getdata,Phone:e.target.value})}
      />
    </div>
    ...
    <div className="md:col-span-5">
      ...
      <input type="text" name="website" id="website" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="www.exmaple.com"
        value={getdata.website}   onChange={(e)=>setgetdata({...getdata,website:e.target.value})}
      />
    </div>
